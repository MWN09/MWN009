function varargout = Spherical_Wrist(varargin)
% Spherical_Wrist MATLAB code for Spherical_Wrist.fig
%      Spherical_Wrist, by itself, creates a new Spherical_Wrist or raises the existing
%      singleton*.
%
%      H = Spherical_Wrist returns the handle to a new Spherical_Wrist or the handle to
%      the existing singleton*.
%
%      Spherical_Wrist('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in Spherical_Wrist.M with the given input arguments.
%
%      Spherical_Wrist('Property','Value',...) creates a new Spherical_Wrist or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Spherical_Wrist_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Spherical_Wrist_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Spherical_Wrist

% Last Modified by GUIDE v2.5 10-Oct-2018 12:34:44

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Spherical_Wrist_OpeningFcn, ...
                   'gui_OutputFcn',  @Spherical_Wrist_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Spherical_Wrist is made visible.
function Spherical_Wrist_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Spherical_Wrist (see VARARGIN)

% Choose default command line output for Spherical_Wrist
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Spherical_Wrist wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Spherical_Wrist_OutputFcn(hObject, eventdata, handles) 
...
for theta1=0:1:theta_1
    for theta2=0:1:theta_2
        ...
        for d6=0:1:l3
            x=d6*cosd(theta1)*sind(theta2);
            y=d6*sind(theta1)*sind(theta2);
            z=d6*cosd(theta2);
            plot3(x,y,z,'*r')
            hold on
