...
def check_keydown_events(event, ai_settings, screen, stats, sb, ship, bullets,  
    ...
    if event.key == pygame.K_RIGHT:
        ...
        #exit the game if q / esc pressed by an user
        sys.exit()
...
def create_fleet(ai_settings, screen, ship, aliens):
    ...
    # centered_fleet =available_space_x - (2 * alien_width * number_aliens_x)
    # if you want to display your fleet in center of the screen
 
    # Create the fleet of aliens.
    for row_number in range(number_rows):
        for alien_number in range(number_aliens_x): # range start from 0
